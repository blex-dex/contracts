...
import {PositionAddMgr} from "../market/PositionAddMgr.sol";
...
contract MockPositionAddMgr is PositionAddMgr {
    ...
    function setOrderStore(bool isLong, bool isOpen, address os) external {

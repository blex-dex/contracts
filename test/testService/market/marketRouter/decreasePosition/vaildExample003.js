...
describe("Keep the leverage part to lighten the position, check the position price and the remaining margin", async () => {
  let allContracts;
  ...
  it("Keep the leverage part to lighten the position, check the position price and the remaining margin", async () => {
    logger.info(
      "---Keep the leverage part to lighten the position, check the position price and the remaining margin---"
    );
    ...
    //Execution of position reduction
    {
      ...
      await validTransfer({
        ...
        amount: amount,
        label:
          "  The funds obtained by user lighten up do not correspond to the expected funds",
        expandDecimals: false,
      });

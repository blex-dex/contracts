...
describe("1700 open long, 1610 close half, keep leverage true", async () => {
  let allContracts;
  ...
  it("1700 open long, 1610 close half, keep leverage true", async () => {
    logger.info("---1700 open long, 1610 close half, keep leverage true---");
    ...
    await setPrice(allContracts.indexToken, 1610);

...
describe("Test case for increasing position size, adding funding, reducing margin but the reduced margin is not enough for funding paid", async () => {
  let allContracts;
  ...
  it("Test case for increasing position size, adding funding, reducing margin but the reduced margin is not enough for funding paid", async () => {
    logger.info(
      "---Test cases for increasing position size, adding funding fee, and reducing margin less than funding fee---"
    );
    ...
    await advanceOneDay();
    {
      ...
      let afterAmount = await balanceOf(second.address);
      await validSize({
        user: second.address,
        price: 1700,
        isLong: true,
